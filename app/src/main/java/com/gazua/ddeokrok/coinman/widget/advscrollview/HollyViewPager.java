package com.gazua.ddeokrok.coinman.widget.advscrollview;
...
public class HollyViewPager extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        addView(LayoutInflater.from(getContext()).inflate(R.layout.chart_coin_picker_view_pager, this, false));
