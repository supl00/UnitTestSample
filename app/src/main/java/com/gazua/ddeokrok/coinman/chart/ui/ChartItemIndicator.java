...
package com.gazua.ddeokrok.coinman.chart.ui;
...
public class ChartItemIndicator extends FrameLayout {
    static abstract class Impl {
        public abstract void onInit(Context context, AttributeSet attrs, int defStyleAttr, ChartItemIndicator thiz);
    ...
    public ChartItemIndicator(Context context) {
        super(context);
        onInit(context, null, 0);
    }

    public ChartItemIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        onInit(context, attrs, 0);
    }

    public ChartItemIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onInit(Context context, AttributeSet attrs, int defStyleAttr) {
        if (shouldUseAnimatedIndicator(context, attrs, defStyleAttr)) {
            mImpl = new ChartItemIndicatorImplAnim();
        } else {
            mImpl = new ChartItemIndicatorImplNoAnim();
        }
