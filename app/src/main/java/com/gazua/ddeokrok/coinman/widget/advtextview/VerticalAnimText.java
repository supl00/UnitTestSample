...
import com.gazua.ddeokrok.coinman.widget.advtextview.base.CharacterDiffResult;
import com.gazua.ddeokrok.coinman.widget.advtextview.base.CharacterUtils;
import com.gazua.ddeokrok.coinman.widget.advtextview.base.DefaultAnimatorListener;
import com.gazua.ddeokrok.coinman.widget.advtextview.base.HText;
...
public class VerticalAnimText extends HText {
    float mostCount = 20;
    float charTime = 400;
    ...
    private boolean mIsFallAnim = false;
    ...
    public void animateText(final CharSequence text) {
        mHTextView.post(new Runnable() {
            ...
            public void run() {
                ...
                VerticalAnimText.super.animateText(text);
            }
        });
    }
    ...
    public void drawFrame(Canvas canvas) {
        if (mIsFallAnim) {
            ...
            drawEvaporateAnim(canvas);
        }
    }

    public void enableFallAnim(boolean enabled) {
        mIsFallAnim = enabled;
    }

    private void drawFallAnim(Canvas canvas) {
    ...
    private void drawEvaporateAnim(Canvas canvas){
